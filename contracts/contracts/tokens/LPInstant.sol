...
/**
 * @title LPInstant
 * @dev LP Token for Tier 1 (Instant Access) deposits
 * @notice Represents shares in the instant liquidity pool
 * Features:
 ...
 */
contract LPInstant is ERC20, Ownable {
     ...
     */
    constructor() ERC20("Dera LP Instant", "dLP-Instant") Ownable(msg.sender) {}
