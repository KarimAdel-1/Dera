...
/**
 * @title LPWarm
 * @dev LP Token for Tier 2 (30-Day Notice) deposits
 * @notice Represents shares in the warm liquidity pool
 * Features:
 ...
 * - 30-day withdrawal notice required
 */
contract LPWarm is ERC20, Ownable {
     ...
     */
    constructor() ERC20("Dera LP Warm", "dLP-Warm") Ownable(msg.sender) {}
