 ...
 * This script:
 * 1. Deploys ConfiguratorLogic library (if needed)
 * 2. Deploys new DeraPoolConfigurator with setAssetDecimals function
 * 3. Updates PoolAddressesProvider to point to new configurator
 * 4. Initializes the new configurator
 */
...
async function main() {
  ...
  console.log("=".repeat(60));
  console.log("STEP 1: Deploy ConfiguratorLogic Library");
  console.log("=".repeat(60) + "\n");

  let configuratorLogicAddress = deploymentInfo.addresses.CONFIGURATOR_LOGIC;

  if (!configuratorLogicAddress) {
    console.log("📚 ConfiguratorLogic library not found in deployment info");
    console.log("🚀 Deploying ConfiguratorLogic library...");
    ...
    configuratorLogicAddress = await configuratorLogic.getAddress();
    console.log("✅ ConfiguratorLogic deployed:", configuratorLogicAddress);

    // Save to deployment info
    deploymentInfo.addresses.CONFIGURATOR_LOGIC = configuratorLogicAddress;
  } else {
    console.log("✅ Using existing ConfiguratorLogic:", configuratorLogicAddress);
  }

  console.log("\n" + "=".repeat(60));
  console.log("STEP 2: Deploy New PoolConfigurator");
  console.log("=".repeat(60) + "\n");
  ...
  console.log("\n" + "=".repeat(60));
  console.log("STEP 3: Update PoolAddressesProvider");
  console.log("=".repeat(60) + "\n");
  ...
  console.log("\n" + "=".repeat(60));
  console.log("STEP 4: Initialize New PoolConfigurator");
  console.log("=".repeat(60) + "\n");
  ...
  console.log("\n" + "=".repeat(60));
  console.log("STEP 5: Verify New PoolConfigurator");
  console.log("=".repeat(60) + "\n");
  ...
  try {
    ...
    const hasFunction = poolConfiguratorInstance.interface.hasFunction('setAssetDecimals');
  ...
  console.log("\n" + "=".repeat(60));
  console.log("STEP 6: Update deployment-info.json");
  console.log("=".repeat(60) + "\n");
  ...
  console.log("   ConfiguratorLogic library saved");
  ...
  console.log("📝 Summary:");
  console.log("   ConfiguratorLogic Library:", configuratorLogicAddress);
